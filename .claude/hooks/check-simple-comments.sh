...
# SEPS rule: keep code comments to one line. Self-clearing — once simplified or
...
if [ -n "$flagged" ]; then
	{
		echo "Verbose multi-line comment block(s) were added. SEPS rule: keep code comments to one line."
