---
name: authentication
description: How authentication works in TTSK - local username/password, SAML 2.0 SSO via slovensko.sk (ÚPVS), and OIDC/OAuth2. Use whenever touching login flows, session handling, protected endpoints, or SSO. Do not reinvent — work with the existing AuthenticationService and OIDCService.
---

# Authentication

TTSK supports three authentication mechanisms, all implemented in the existing codebase.
