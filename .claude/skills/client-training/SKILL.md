...
description: How we produce client-facing training and onboarding material for TTSK - step-by-step guides with screenshots that teach the client to use the procurement system. Use when preparing training/onboarding material, user guides, or when the user mentions "školenie", "tréningový materiál", "podklady pre klienta", "návod pre používateľa", "onboarding klienta". Generated from the built feature, in Slovak.
---

# Client training material (TTSK)
